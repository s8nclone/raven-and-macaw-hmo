...
const PageIntro = () => {
    return (
        <div className="m-2 p-4 grid grid-cols-1 lg:grid-cols-2 shadow-lg text-left leading-loose">
            ...
            <div>
                <img className="rounded float-right md:max-h-[150] md:max-w-[350] lg:max-h-[350] lg:max-w-[500]" src={image} alt="family and business partnerss" />
            </div>
        </div>
    );
}
