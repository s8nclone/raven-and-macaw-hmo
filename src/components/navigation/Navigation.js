...
const Navigation = () => {
    return (
        <nav className="bg-white shadow-lg sticky top-0 left-0 right-0">
            <div className="p-2 flex justify-between ">
                <div className="flex space-x-4 items-center">
                    <img  className="rounded-r-lg" style={{maxWidth:50, maxHeight:50}} alt="raven and macaw logo" src={logo} />
                    <h2 className="text-xl font-bold">Raven & Macaw<span className="text-orange-600">HMO</span></h2>
                </div>
                
                <div className="flex space-x-6 items-center text-lg font-semibold">
